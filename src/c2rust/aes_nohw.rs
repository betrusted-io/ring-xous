...
#[inline]
unsafe extern "C" fn CRYPTO_store_u32_be(mut out: *mut core::ffi::c_void, mut v: uint32_t) {
    v = CRYPTO_bswap4(v);
    OPENSSL_memcpy(
        out,
...
#[inline]
unsafe extern "C" fn CRYPTO_load_u32_be(mut in_0: *const core::ffi::c_void) -> uint32_t {
