...
#![feature(asm, label_break_value, register_tool)]
use std::arch::asm;
extern "C" {
    fn __assert_fail(
...
unsafe extern "C" fn limb_adc(
    ...
    let mut x: DoubleLimb = (a as DoubleLimb)
        ...
        .wrapping_add(carry_in as libc::c_ulonglong);
    *r = x as Limb;
    ret = (x >> 32 as libc::c_uint) as Carry;
    return ret;
}
#[inline]
unsafe extern "C" fn limb_add(mut r: *mut Limb, mut a: Limb, mut b: Limb) -> Carry {
    let mut ret: Carry = 0;
    let mut x: DoubleLimb = (a as DoubleLimb).wrapping_add(b as libc::c_ulonglong);
    *r = x as Limb;
    ret = (x >> 32 as libc::c_uint) as Carry;
    return ret;
}
...
unsafe extern "C" fn limb_sbb(
    ...
    let mut ret: Carry = 0;
    let mut x: DoubleLimb = (a as DoubleLimb)
        .wrapping_sub(b as libc::c_ulonglong)
        .wrapping_sub(borrow_in as libc::c_ulonglong);
    *r = x as Limb;
    ret = (x >> 32 as libc::c_uint & 1 as libc::c_int as libc::c_ulonglong) as Carry;
    return ret;
}
#[inline]
unsafe extern "C" fn limb_sub(mut r: *mut Limb, mut a: Limb, mut b: Limb) -> Carry {
    let mut ret: Carry = 0;
    let mut x: DoubleLimb = (a as DoubleLimb).wrapping_sub(b as libc::c_ulonglong);
    *r = x as Limb;
    ret = (x >> 32 as libc::c_uint & 1 as libc::c_int as libc::c_ulonglong) as Carry;
    return ret;
}
...
unsafe extern "C" fn limbs_add(
    ...
    if num_limbs >= 1 as libc::c_int as libc::c_uint {} else {
        __assert_fail(
            b"num_limbs >= 1\0" as *const u8 as *const libc::c_char,
    ...
    let mut carry: Carry = limb_add(
        &mut *r.offset(0 as libc::c_int as isize),
...
unsafe extern "C" fn limbs_zero(mut r: *mut Limb, mut num_limbs: size_t) {
    let mut i: size_t = 0 as libc::c_int as size_t;
    while i < num_limbs {
        *r.offset(i as isize) = 0 as libc::c_int as Limb;
        i = i.wrapping_add(1);
    }
}
...
static mut N: [BN_ULONG; 12] = [
    0xccc52973 as libc::c_uint,
    0xecec196a as libc::c_uint,
    0x48b0a77a as libc::c_int as BN_ULONG,
    0x581a0db2 as libc::c_int as BN_ULONG,
    0xf4372ddf as libc::c_uint,
    0xc7634d81 as libc::c_uint,
    0xffffffff as libc::c_uint,
    0xffffffff as libc::c_uint,
    0xffffffff as libc::c_uint,
    0xffffffff as libc::c_uint,
...
static mut Q_PLUS_1_SHR_1: Elem = [
    ...
    0 as libc::c_int as Limb,
    0x80000000 as libc::c_uint,
    0x7fffffff as libc::c_int as Limb,
    0xffffffff as libc::c_uint,
    0xffffffff as libc::c_uint,
    0xffffffff as libc::c_uint,
    0xffffffff as libc::c_uint,
...
static mut N_N0: [BN_ULONG; 2] = [
    0xe88fdc45 as libc::c_uint,
    0x6ed46089 as libc::c_int as BN_ULONG,
];
#[inline]
unsafe extern "C" fn is_equal(mut a: *const Limb, mut b: *const Limb) -> Limb {
    return LIMBS_equal(a, b, (384 as libc::c_uint).wrapping_div(32 as libc::c_uint));
}
#[inline]
unsafe extern "C" fn is_zero(mut a: *const BN_ULONG) -> Limb {
    return LIMBS_are_zero(a, (384 as libc::c_uint).wrapping_div(32 as libc::c_uint));
}
#[inline]
unsafe extern "C" fn copy_conditional(
    ...
    let mut i: size_t = 0 as libc::c_int as size_t;
    while i < (384 as libc::c_uint).wrapping_div(32 as libc::c_uint) {
        *r
            .offset(
                i as isize,
...
unsafe extern "C" fn elem_add(mut r: *mut Limb, mut a: *const Limb, mut b: *const Limb) {
    LIMBS_add_mod(
        ...
        b,
        Q.as_ptr(),
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
}
#[inline]
...
unsafe extern "C" fn elem_div_by_2(mut r: *mut Limb, mut a: *const Limb) {
    let mut is_odd: Limb = constant_time_is_nonzero_w(
        *a.offset(0 as libc::c_int as isize) & 1 as libc::c_int as libc::c_uint,
    );
    ...
    *r
    ...
    while i < (384 as libc::c_uint).wrapping_div(32 as libc::c_uint) {
        ...
        *r
            ...
            | carry
                << (32 as libc::c_uint).wrapping_sub(1 as libc::c_int as libc::c_uint);
        carry = new_carry;
        i = i.wrapping_add(1);
    }
...
#[no_mangle]
pub unsafe extern "C" fn p384_elem_sub(
    mut r: *mut Limb,
    mut a: *const Limb,
    mut b: *const Limb,
) {
...
unsafe extern "C" fn p384_point_select_w5(
    ...
    let mut x: Elem = [0; 12];
    limbs_zero(x.as_mut_ptr(), (384 as libc::c_uint).wrapping_div(32 as libc::c_uint));
    let mut y: Elem = [0; 12];
    limbs_zero(y.as_mut_ptr(), (384 as libc::c_uint).wrapping_div(32 as libc::c_uint));
    let mut z: Elem = [0; 12];
    limbs_zero(z.as_mut_ptr(), (384 as libc::c_uint).wrapping_div(32 as libc::c_uint));
    let mut i: size_t = 0 as libc::c_int as size_t;
    while i < 16 as libc::c_int as libc::c_uint {
        ...
        while j < (384 as libc::c_uint).wrapping_div(32 as libc::c_uint) {
            x[j
...
unsafe extern "C" fn booth_recode(
    ...
    if w >= 2 as libc::c_int as libc::c_uint {} else {
        __assert_fail(
            b"w >= 2\0" as *const u8 as *const libc::c_char,
            b"crypto/fipsmodule/ec/ecp_nistz.h\0" as *const u8 as *const libc::c_char,
            251 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<
                &[u8; 82],
                &[libc::c_char; 82],
            >(
                b"void booth_recode(crypto_word_t *, crypto_word_t *, crypto_word_t, crypto_word_t)\0",
            ))
                .as_ptr(),
        );
    }
    if w <= 7 as libc::c_int as libc::c_uint {} else {
        __assert_fail(
            b"w <= 7\0" as *const u8 as *const libc::c_char,
            b"crypto/fipsmodule/ec/ecp_nistz.h\0" as *const u8 as *const libc::c_char,
    ...
    let mut s: crypto_word_t = !(in_0 >> w)
        .wrapping_sub(1 as libc::c_int as libc::c_uint);
    let mut d: crypto_word_t = 0;
    d = ((1 as libc::c_uint) << w.wrapping_add(1 as libc::c_int as libc::c_uint))
        .wrapping_sub(in_0)
        .wrapping_sub(1 as libc::c_int as libc::c_uint);
    d = d & s | in_0 & !s;
    d = (d >> 1 as libc::c_int).wrapping_add(d & 1 as libc::c_int as libc::c_uint);
    *is_negative = constant_time_is_nonzero_w(s & 1 as libc::c_int as libc::c_uint);
    *digit = d;
}
unsafe extern "C" fn nistz384_point_double(
...
unsafe extern "C" fn add_precomputed_w5(
    ...
    booth_recode(
        ...
        &mut recoded,
        wvalue,
        5 as libc::c_int as crypto_word_t,
    );
...
unsafe extern "C" fn nistz384_point_mul(
    ...
    static mut kWindowSize: size_t = 5 as libc::c_int as size_t;
    static mut kMask: crypto_word_t = (((1 as libc::c_int)
        << 5 as libc::c_int + 1 as libc::c_int) - 1 as libc::c_int) as crypto_word_t;
    let mut p_str: [uint8_t; 49] = [0; 49];
    little_endian_bytes_from_scalar(
        p_str.as_mut_ptr(),
        (::std::mem::size_of::<[uint8_t; 49]>() as libc::c_ulong)
    ...
    limbs_copy(
        ((*row.offset((1 as libc::c_int - 1 as libc::c_int) as isize)).X).as_mut_ptr(),
        p_x,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    limbs_copy(
        ((*row.offset((1 as libc::c_int - 1 as libc::c_int) as isize)).Y).as_mut_ptr(),
        p_y,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    limbs_copy(
        ((*row.offset((1 as libc::c_int - 1 as libc::c_int) as isize)).Z).as_mut_ptr(),
        ONE.as_ptr(),
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    nistz384_point_double(
        &mut *row.offset((2 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((1 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_add(
        &mut *row.offset((3 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((2 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((1 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_double(
        &mut *row.offset((4 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((2 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_double(
        &mut *row.offset((6 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((3 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_double(
        &mut *row.offset((8 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((4 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_double(
        &mut *row.offset((12 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((6 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_add(
        &mut *row.offset((5 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((4 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((1 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_add(
        &mut *row.offset((7 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((6 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((1 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_add(
        &mut *row.offset((9 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((8 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((1 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_add(
        &mut *row.offset((13 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((12 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((1 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_double(
        &mut *row.offset((14 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((7 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_double(
        &mut *row.offset((10 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((5 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_add(
        &mut *row.offset((15 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((14 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((1 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_add(
        &mut *row.offset((11 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((10 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((1 as libc::c_int - 1 as libc::c_int) as isize),
    );
    nistz384_point_double(
        &mut *row.offset((16 as libc::c_int - 1 as libc::c_int) as isize),
        &mut *row.offset((8 as libc::c_int - 1 as libc::c_int) as isize),
    );
    static mut START_INDEX: size_t = (384 as libc::c_int - 4 as libc::c_int) as size_t;
    let mut index: size_t = START_INDEX;
    let mut recoded_is_negative: BN_ULONG = 0;
    let mut recoded: crypto_word_t = 0;
    let mut wvalue: crypto_word_t = p_str[index
        .wrapping_sub(1 as libc::c_int as libc::c_uint)
        .wrapping_div(8 as libc::c_int as libc::c_uint) as usize] as crypto_word_t;
    wvalue = wvalue
        >> index
            .wrapping_sub(1 as libc::c_int as libc::c_uint)
            .wrapping_rem(8 as libc::c_int as libc::c_uint) & kMask;
    booth_recode(
        &mut recoded_is_negative,
        &mut recoded,
        wvalue,
    ...
    while index >= kWindowSize {
        if index != START_INDEX {
            ...
            wvalue = (p_str[off as usize] as libc::c_int
                | (p_str[off.wrapping_add(1 as libc::c_int as libc::c_uint) as usize]
                    as libc::c_int) << 8 as libc::c_int) as crypto_word_t;
            wvalue = wvalue
                >> index
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_rem(8 as libc::c_int as libc::c_uint) & kMask;
        ...
        index = (index as libc::c_uint).wrapping_sub(kWindowSize) as size_t as size_t;
    ...
    wvalue = p_str[0 as libc::c_int as usize] as crypto_word_t;
    wvalue = wvalue << 1 as libc::c_int & kMask;
    add_precomputed_w5(r, wvalue, table.as_mut_ptr() as *const P384_POINT);
}
#[no_mangle]
pub unsafe extern "C" fn p384_point_double(
    mut r: *mut [Limb; 12],
    mut a: *const [Limb; 12],
) {
    ...
    limbs_copy(
        (t.Z).as_mut_ptr(),
        (*a.offset(2 as libc::c_int as isize)).as_ptr(),
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    nistz384_point_double(&mut t, &mut t);
    limbs_copy(
        (*r.offset(0 as libc::c_int as isize)).as_mut_ptr(),
        (t.X).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    limbs_copy(
        (*r.offset(1 as libc::c_int as isize)).as_mut_ptr(),
        (t.Y).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    limbs_copy(
        (*r.offset(2 as libc::c_int as isize)).as_mut_ptr(),
        (t.Z).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
}
#[no_mangle]
pub unsafe extern "C" fn p384_point_add(
    ...
    let mut t2: P384_POINT = P384_POINT {
        X: [0; 12],
        Y: [0; 12],
        Z: [0; 12],
    };
    ...
    limbs_copy(
        (t2.Z).as_mut_ptr(),
        (*b.offset(2 as libc::c_int as isize)).as_ptr(),
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    nistz384_point_add(&mut t1, &mut t1, &mut t2);
    limbs_copy(
        (*r.offset(0 as libc::c_int as isize)).as_mut_ptr(),
        (t1.X).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    limbs_copy(
        (*r.offset(1 as libc::c_int as isize)).as_mut_ptr(),
        (t1.Y).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    limbs_copy(
        (*r.offset(2 as libc::c_int as isize)).as_mut_ptr(),
        (t1.Z).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
}
#[no_mangle]
pub unsafe extern "C" fn p384_point_mul(
    ...
    nistz384_point_mul(&mut acc, p_scalar, p_x, p_y);
    limbs_copy(
        (*r.offset(0 as libc::c_int as isize)).as_mut_ptr(),
        (acc.X).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    limbs_copy(
        (*r.offset(1 as libc::c_int as isize)).as_mut_ptr(),
        (acc.Y).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
    limbs_copy(
        (*r.offset(2 as libc::c_int as isize)).as_mut_ptr(),
        (acc.Z).as_mut_ptr() as *const Limb,
        (384 as libc::c_uint).wrapping_div(32 as libc::c_uint),
    );
}
